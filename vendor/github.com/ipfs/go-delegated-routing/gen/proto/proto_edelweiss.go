...
func (x *Node_MapIterator) Next() (key pd3.Node, value pd3.Node, err error) {
	if x.done {
		...
		case x.s.Proof != nil:
			return pd1.String("proof"), x.s.Proof.Node(), nil
...
func (x Node) LookupByString(key string) (pd3.Node, error) {
	...
	case x.Proof != nil && key == "proof":
		return x.Proof.Node(), nil
...
// -- protocol type AnonLink23 --

type AnonLink23 pd16.Cid

func (v *AnonLink23) Parse(n pd3.Node) error {
	if n.Kind() != pd3.Kind_Link {
		return pd1.ErrNA
	} else {
		ipldLink, _ := n.AsLink()
		...
		if !ok {
			...
			*v = AnonLink23(cidLink.Cid)
			return nil
		}
	}
}

func (v AnonLink23) Node() pd3.Node {
	return v
}

func (AnonLink23) Kind() pd3.Kind {
	return pd3.Kind_Link
}

func (AnonLink23) LookupByString(string) (pd3.Node, error) {
	return nil, pd1.ErrNA
}

func (AnonLink23) LookupByNode(key pd3.Node) (pd3.Node, error) {
	return nil, pd1.ErrNA
}

func (AnonLink23) LookupByIndex(idx int64) (pd3.Node, error) {
	return nil, pd1.ErrNA
}

func (AnonLink23) LookupBySegment(seg pd3.PathSegment) (pd3.Node, error) {
	return nil, pd1.ErrNA
}

func (AnonLink23) MapIterator() pd3.MapIterator {
	return nil
}

func (AnonLink23) ListIterator() pd3.ListIterator {
	return nil
}

func (AnonLink23) Length() int64 {
	return -1
}

func (AnonLink23) IsAbsent() bool {
	return false
}

func (AnonLink23) IsNull() bool {
	return false
}

func (AnonLink23) AsBool() (bool, error) {
	return false, pd1.ErrNA
}

func (v AnonLink23) AsInt() (int64, error) {
	return 0, pd1.ErrNA
}

func (AnonLink23) AsFloat() (float64, error) {
	return 0, pd1.ErrNA
}

func (AnonLink23) AsString() (string, error) {
	return "", pd1.ErrNA
}

func (AnonLink23) AsBytes() ([]byte, error) {
	return nil, pd1.ErrNA
}

func (v AnonLink23) AsLink() (pd3.Link, error) {
	return pd17.Link{Cid: pd16.Cid(v)}, nil
}

func (AnonLink23) Prototype() pd3.NodePrototype {
	return nil // not needed
}
...
func (x *Proof) Parse(n pd3.Node) error {
	*x = Proof{}
	if n.Kind() != pd3.Kind_Map {
		return pd1.ErrNA
	}
...
type Proof_MapIterator struct {
	done bool
	s    *Proof
}

func (x *Proof_MapIterator) Next() (key pd3.Node, value pd3.Node, err error) {
	if x.done {
		return nil, nil, pd1.ErrNA
	} else {
		x.done = true
		switch {
		case x.s.MD != nil:
			return pd1.String("md"), x.s.MD.Node(), nil
...
func (x *Proof_MapIterator) Done() bool {
	return x.done
}

func (x Proof) Node() pd3.Node {
	return x
}

func (x Proof) Kind() pd3.Kind {
	return pd3.Kind_Map
}

func (x Proof) LookupByString(key string) (pd3.Node, error) {
	switch {
	case x.MD != nil && key == "md":
		return x.MD.Node(), nil
...
func (x Proof) LookupByNode(key pd3.Node) (pd3.Node, error) {
	if key.Kind() != pd3.Kind_String {
		return nil, pd1.ErrNA
	}
	if s, err := key.AsString(); err != nil {
...
func (x Proof) LookupByIndex(idx int64) (pd3.Node, error) {
	return nil, pd1.ErrNA
}

func (x Proof) LookupBySegment(seg pd3.PathSegment) (pd3.Node, error) {
	switch seg.String() {
	case "md":
		return x.MD.Node(), nil
...
func (x Proof) MapIterator() pd3.MapIterator {
	return &Proof_MapIterator{false, &x}
}

func (x Proof) ListIterator() pd3.ListIterator {
	return nil
}

func (x Proof) Length() int64 {
	return 1
}

func (x Proof) IsAbsent() bool {
	return false
}

func (x Proof) IsNull() bool {
	return false
}

func (x Proof) AsBool() (bool, error) {
	return false, pd1.ErrNA
}

func (x Proof) AsInt() (int64, error) {
	return 0, pd1.ErrNA
}

func (x Proof) AsFloat() (float64, error) {
	return 0, pd1.ErrNA
}

func (x Proof) AsString() (string, error) {
	return "", pd1.ErrNA
}

func (x Proof) AsBytes() ([]byte, error) {
	return nil, pd1.ErrNA
}

func (x Proof) AsLink() (pd3.Link, error) {
	return nil, pd1.ErrNA
}

func (x Proof) Prototype() pd3.NodePrototype {
	return nil
}
